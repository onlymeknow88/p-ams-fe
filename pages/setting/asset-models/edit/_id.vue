<template>
  <div>
    <div v-if="models.result.role.edit == 'N'">
...
export default {
  ...
  async asyncData({ store, params }) {
    await Promise.all([
      store.dispatch('setting/asset_models/getData', params.id),
      store.dispatch('setting/asset_models/getModelsData')
    ])
    return
  },
  computed: {
    ...
    errorPage() {
      if (this.models.result.role.edit == 'N') {
