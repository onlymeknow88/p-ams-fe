<template>
  <div>
    <div v-if="models.result.role.access == 'N'">
              ...
              <div class="card-body">
                <div class="card-title">
                  <div class="col-12 item-title">
                    <h6 class="fw-bold">Asset Model</h6>
                    <NuxtLink
                      :to="{ name: 'setting-asset-models-create' }"
                      class="btn btn-icon"
                      title="Add"
                      :class="
                        models.result.role.create == 'Y' ? '' : 'disabled'
                      "
                    >
                      <svg
                        width="24"
                ...
                <div class="table-responsive">
                  ...
                  <b-table
                    v-else
                    hover
                    :items="models.result.models.data"
                    :fields="fields"
                    show-empty
                    :sort-by.sync="sortBy"
                    ...
                    <template v-slot:cell(actions)="row">
                      <div class="d-flex justify-content-start">
                        <NuxtLink
                          ...
                          :class="
                            models.result.role.edit == 'Y' ? '' : 'disabled'
                          "
                          title="Edit"
                          :to="{
                            name: 'setting-asset-models-edit-id',
                        ...
                        <button
                          ...
                          class="btn btn-icon color-softgray-5 mr-6"
                          :class="
                            models.result.role.delete == 'Y' ? '' : 'disabled'
                          "
                          title="Delete"
                ...
                <div class="col-xl-12 mt-4">
                  <div class="pagination-footer">
                    <span class="form-text-13 mb-3"
                      >Page
                      {{
                        models.result.models.from
                          ? models.result.models.from
                          : 0
                      }}
                      of
                      {{
                        models.result.models.to ? models.result.models.to : 0
                      }}
                      Showing
...
export default {
  name: 'Asset-Models',
  async fetch() {
    await this.$axios.$get('asset-models')
  },
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'models_type', sortable: false },
  ...
  methods: {
    ...
    ...mapMutations('setting/asset_models', ['SET_PAGE', 'SET_LIMIT']),
    findSearch(e) {
    ...
    deleteCategory(id) {
      Swal.fire({
        ...
        if (e.value == true) {
          this.destroyModelsData(id).then()
        }
      })
    },
  },
